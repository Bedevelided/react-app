...
import { addTask , taskComplete , filterByDone , filterByNotDone , updateTask} from '../JS/Actions/actions';
    ...
    <div className='container'>
        ...
        <div className='container-dark'>
            ...
            <div className='filter'>
                ...
                <button type="button" onClick={() => filterByNotDone()}>Not Done</button>
                <button type="button" onClick={() => filterByDone()}>Done</button>
            </div>
        </div>
        </div>
    </div>
